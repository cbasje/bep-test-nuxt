<template>
  <main>
    ...
    >
      ...
      >
        <template #title>
          {{ feedbackTitle ? feedbackTitle : 'Feedback' }}
        </template>
        <template #content>
              ...
              <div class="px-4 py-5 space-y-6 sm:p-6">
                ...
                <div>
                  ...
                  <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                    Wat vind je niet goed aan deze plek? Of wat vind je wel
                    goed?
                  </p>
                </div>
  ...
  methods: {
    ...
    openPopupForSolution() {
      if (this.$route.query.sol && typeof this.$route.query.sol === 'string') {
        ...
        if (currentSolution) {
          this.feedbackTitle = currentSolution.name
          this.location = L.latLng(currentSolution.lat, currentSolution.lng)
